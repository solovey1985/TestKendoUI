namespace TestKendoUI.Data
{
    ...
    public partial class AbventureModel : DbContext
    {
        public AbventureModel()
            : base("name=AbventureModel")
        {
        }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<vPersonDemographics>()
            ...
            modelBuilder.Entity<vSalesPersonSalesByFiscalYears>()
                .Property(e => e.C2002)
                .HasPrecision(19, 4);
